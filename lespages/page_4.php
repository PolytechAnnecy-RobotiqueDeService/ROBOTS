...
<div id='fond'>
    ...
    //echo getcwd();
        ...
        $compterendu[8]="<p>résumé séance 8 à faire</p>";
        ...
        while (isset($semestre[$a])){ //parcours des semestres
            ...
            echo"<ul>"; //début liste séances
                ...
                while (isset($seance[$b])){ //parcours des séances
                    ...
                    echo "<div class='text'><span class ='cr'>".$date_seance[$b].$compterendu[$b]."<a href=\"./documents/comptes_rendus/compte_rendu_".$b.".pdf\" target=’_blank’>Compte-rendu de la séance ".$b."</a></span></div>";
                    echo "</div></br>";
