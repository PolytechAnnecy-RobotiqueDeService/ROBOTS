...
<html>
<head>
	<link rel="stylesheet" href="lespages/page_0.css">
	...
	<div class="container">
		...
		<div class="parent">
			<div class="son">
				...
				<img id="pepper" src="documents/images/Rpepper.jpg" />
				<p>Pepper est le premier robot humanoïde au monde capable d'identifier les visages et les principales
		...
		<!-- video en dessous des texte et alligner-->
		<div class="parent">
			<div class="son">
